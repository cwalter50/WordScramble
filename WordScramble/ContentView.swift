...
//  WordScramble
//
//  Created by Christopher Walter on 4/19/20.
...
struct ContentView: View {
    ...
    // used to make sure that each word added isn't already on the list.
    func isOriginal(word: String) -> Bool {
        !usedWords.contains(word)
    }
    
    // this method is used to make sure that the word we enter can be made up of the letters in the root word
    ...
    func addNewWord() {
        ...
        // Make sure that the word is original, possible, and real
